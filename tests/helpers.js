...
async function loadSidebarWorld({ sync = {}, local = {}, models = [], ollamaModels = null, fetchLlm = () => ({ data: "OK" }), vram = [], info = null, psError = null, caps = null, pythonExec = null, listModels = null, embed = null } = {}) {
    const unloadCalls = [];
