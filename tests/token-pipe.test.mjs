...
describe("the pipe dialect is described once", () => {
    ...
    test("no tool PARAMETER carries the dialect verbatim any more", async () => {
        const files = ["../src/tools.ts", "../src/builtin-tools.ts", "../src/python-tool.ts", "../src/injected.ts", "../src/ml-server.ts", "../src/ml-tool-factories.ts", "../src/ml-vision.ts", "../src/ml-python.ts", "../src/ml-chat.ts", "../src/ml-agent-run.ts"];
