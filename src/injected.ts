...
import { emitDebug, sessionRegistry, agentRegistry, handleRegistry, enterAgentRun, exitAgentRun, resetSubcallUsage, subcallUsage } from "./bus";
...
import { executeTool, toolContext, currentAnswer, currentDeref, currentServerAllow, currentHasTool, withRunDeref } from "./tool-exec";
