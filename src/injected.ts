 ...
 */
const models = async function(): Promise<string[]> {
 ...
 */
const serverTools = async function(): Promise<ServerTool[]> {
 ...
 */
const execServerTool = async function(
    toolId: string,
    name: string,
 ...
 */
const info = async function(): Promise<OllamaInfo | null> {
 ...
 */
const capabilities = async function(model: string | null = null): Promise<string[] | null> {
 ...
 */
const getModel = async function(): Promise<string | null> {
 ...
 */
const embed = async function<T extends string | string[]>(input: T, opts?: { model?: string }): Promise<T extends string[] ? Embedding[] : Embedding> {
 ...
 */
const config = async function(): Promise<MlPublicConfig> {
 ...
 */
const setModel = async function(model: string): Promise<string> {
 ...
 */
const ps = async function(): Promise<LoadedModel[]> {
 ...
 */
const unload = async function(model: string | null = null): Promise<string[]> {
