 ...
 */
const _loadTable = async function(this: MlApi, name: string, src: string | Element | TableValue, raw = false): Promise<LoadedTable> {
 ...
 */
const _resolveTable = function(target: string | Element, raw = false): { kind: "rows"; columns: string[]; rows: (string | number | boolean | null)[][] } | { kind: "html"; html: string } {
