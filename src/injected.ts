...
import { buildServerTools, targetRender, captureVerify, lookViews, BOX_OVER_TEXT_TIP, VIEWS_PARAM, legendFor, setCdpEnabled } from "./builtin-tools";
 ...
 */
const read = async function(this: MlApi, image: string | HTMLImageElement, { model = null, prompt = null, numCtx = null }: { model?: string | null; prompt?: string | null; numCtx?: number | null } = {}): Promise<string> {
 ...
 */
const screenshot = async function(this: MlApi, target: string | Element | null = null, { scroll = true, fullPage = false, index = 0, raw = false, margin = 0, noOverlay = false, capture = null }: { scroll?: boolean; fullPage?: boolean; index?: number; raw?: boolean; margin?: number; noOverlay?: boolean; capture?: string | null } = {}): Promise<string> {
 ...
 */
const _shotBox = function(target: string | Element, margin = 0): ShotBox | null {
 ...
 */
const _stitchFullPage = async function(capture: () => Promise<string>): Promise<string> {
    const dpr = window.devicePixelRatio || 1;
 ...
 */
const _resolveVisionModel = async function(this: MlApi, agentModel: string | null, vision: boolean | string | null): Promise<string | null> {
 ...
 */
const _modelSees = async function(this: MlApi, model: string | null): Promise<boolean> {
 ...
 */
const _nativeLookTool = function(this: MlApi, memory?: VisionMemory): MlTool {
    const ml = this;
 ...
 */
const _imageToDataUrl = async function(this: MlApi, image: string | HTMLImageElement): Promise<string> {
    let url = "";
 ...
 */
const _fetchImageBase64 = async function(url: string): Promise<string> {
