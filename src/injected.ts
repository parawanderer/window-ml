...
import { truncate, errText, elPath, describeSkeleton, queryAll, selectorError, externalSheetIds, setPierceClosedShadow, viewportRect, jsonShape, joinShapes, jsonValue, shadowHostReport, clickSelector, elLine, isCurrentPage, typeFromExtension } from "./dom";
 ...
 */
const createChat = function(this: MlApi, { system = null, model = null, extend = null, numCtx = null, numGpu = null, think = false, schema = null, toolIds = null, maxTokens = null, save = false, use = undefined }: Pick<ChatOptions, "system" | "model" | "extend" | "numCtx" | "numGpu" | "think" | "schema" | "toolIds" | "maxTokens" | "use"> & { save?: boolean } = {}): MlHistory {
 ...
 */
const resumeChat = async function(this: MlApi, hash: string): Promise<MlHistory> {
 ...
 */
const chat = async function(this: MlApi, prompt: string, options: ChatOptions = {}): Promise<string | unknown> {
 ...
 */
const step = async function(messages: NeutralMessage[], { tools = [], model = null, think = null, signal = null, hint = null }: {
    tools?: unknown[];
    model?: string | null;
    think?: boolean | null;
    signal?: AbortSignal | null;
