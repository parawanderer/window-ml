 ...
 */
const defineTool = function({ name, description = "", summary, parameters = { type: "object", properties: {} }, run, requiresApproval = false, capabilities = [], render, precheck }: Partial<MlTool> = {}): MlTool {
 ...
 */
const lookTool = function(this: MlApi, opts: { model?: string | null; maxTokens?: number; memory?: VisionMemory } = {}): MlTool {
 ...
 */
const locateTool = function(this: MlApi, opts: { model?: string | null; groundingModel?: string | null; groundingRange?: number; maxTokens?: number; memory?: VisionMemory } = {}): MlTool {
 ...
 */
const clickTool = function(this: MlApi): MlTool {
 ...
 */
const typeTool = function(this: MlApi): MlTool {
 ...
 */
const navigateTool = function(this: MlApi, opts: { crossOrigin?: boolean } = {}): MlTool {
    const ml = this;
 ...
 */
const fetchTool = function(this: MlApi): MlTool {
    const ml = this;
 ...
 */
const pythonTool = function(this: MlApi): MlTool {
 ...
 */
const chatMetaTool = function(this: MlApi): MlTool {
    return {
        name: "chat_metadata",
