...
import type { Wire, UnavailableGPU, GPUInfo, GPUProcess, ProfileDevice, ProfileFailure, ExpectedDecode as WireExpectedDecode,
    ...
    ModelPlacement, ProcessModelResponse, InfoResponse, BoxProfile as WireBoxProfile } from "./events-wire";
